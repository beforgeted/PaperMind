...
_FACTORIES: dict[str, ToolFactory] = {
    ...
    "search_memories": ToolFactory(
        "search_memories", "app.agent.tools.memory_tools", "search_memories"
    ),
    "consolidate_memories": ToolFactory(
        "consolidate_memories", "app.agent.tools.memory_tools", "consolidate_memories"
    ),
    "forget_memories": ToolFactory(
        "forget_memories", "app.agent.tools.memory_tools", "forget_memories"
    ),
    "get_memory_stats": ToolFactory(
        "get_memory_stats", "app.agent.tools.memory_tools", "get_memory_stats"
    ),
